...
### TestResults 패턴
테스트 실행 후 결과 요약을 출력하기 위해 `TestResults` 클래스를 사용합니다.
...
class SampleTest(TestCase):
    ...
    def test_example(self):
        ...
        try:
            ...
            TestResults.add("test_example", "PASS")
        except AssertionError:
            TestResults.add("test_example", "FAIL")
            raise
...
테스트 결과 요약
==================================================
[PASS] test_active_user_returns_true
[PASS] test_inactive_user_returns_false
[PASS] test_create_new_user
[FAIL] test_no_change
==================================================
```

### 테스트 코드 구조
- `django.test.TestCase`와 `django.test.Client` 사용 (DRF의 `APITestCase` 사용하지 않음)
- 각 테스트 메서드에서 try-except로 결과 기록
- 마지막 테스트 클래스의 `tearDownClass`에서 요약 출력